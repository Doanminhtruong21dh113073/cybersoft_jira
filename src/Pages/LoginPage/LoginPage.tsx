...
import { USER_SIGNIN_SAGA } from "../../Redux/Constants/UserConstant";
import images from "./../../Assets/images/login_bg.jpg";
...
export const LoginPage: React.FC = (props) => {
  ...
  return (
    ...
    //           <div className="text text-red-700">{frmLogin.errors.email} </div>
    //         )}
    //       </div>
    //       <div className="flex flex-col text-gray-400 py-2">
    //         <div className="flex items-center">
    //           <i className="bi bi-person-lock mr-2"></i>
    ...
    //           <div className="text text-red-700">
    //             {frmLogin.errors.passWord}{" "}
    //           </div>
    //         )}
    //       </div>
  ...
  flex items-center justify-center"
      >
        <div className="w-full h-100">
          ...
          <form className="mt-6" onSubmit={frmLogin.handleSubmit}>
            <div>
            ...
            <div className="mt-4">
              <label className="block text-gray-700">Pasword</label>
              <input
                type="password"
